...
public void ReturnUpdate(){
   ...
   String o="";
        ...
        try{
            ...
            else if((diffdays>3)&&(click_check<=0)){
...
try{
    ...
    private void initComponents() {
        ...
        jDateChooser1.setMinSelectableDate(new java.util.Date(1581967910000L));
        ...
        setSize(new java.awt.Dimension(1415, 810));
